		...
		LOD 0
			...
			Pass {
				...
				fixed4 frag ( v2f i  ) : SV_Target
				{
					...
					float2 texCoord82 = i.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
					float2 UV96 = texCoord82;
					float2 appendResult39 = (float2(_RippleScroll , 0.0));
					float2 temp_cast_0 = (tex2D( _RippleTexture, ( (UV96*_RippleScale + 0.0) + ( appendResult39 * _Time.y ) ) ).r).xx;
					float2 lerpResult31 = lerp( UV96 , temp_cast_0 , _RippleValue);
					float2 UVDistortion124 = lerpResult31;
					float4 tex2DNode3 = tex2D( _MainTex, (( _UVDistortion )?( UVDistortion124 ):( UV96 )) );
					float2 appendResult68 = (float2(_MaskScroll , 0.0));
					float BlendMask100 = pow( tex2D( _MaskTex, ( (UV96*_MaskScale + 0.0) + ( appendResult68 * _Time.y ) ) ).r , _MaskValue );
					float GradientOpacity128 = ( ( ( 1.0 - UV96.x ) - ( ( _BotFadeRange * ( _BotFadeSmooth + 1.0 ) ) - _BotFadeSmooth ) ) * ( 1.0 / _BotFadeSmooth ) );
					float clampResult26 = clamp( (( _ForceParticle1 )?( 1.0 ):( GradientOpacity128 )) , 0.0 , 1.0 );
...
/*ASEBEGIN
Version=18400
1188;107;1920;757;3755.489;785.7968;2.678343;True;False
Node;AmplifyShaderEditor.CommentaryNode;116;-3977.507,-506.8636;Inherit;False;293;165;UV Setup;1;96;;1,0.8416586,0.1921569,1;0;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;82;-4271.733,-453.0276;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;40;-4937.462,267.0324;Float;False;Property;_RippleScroll;Ripple Scroll;16;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;96;-3927.507,-456.8636;Inherit;False;UV;-1;True;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;49;-4758.602,133.8554;Float;False;Property;_RippleScale;Ripple Scale;15;0;Create;True;0;0;False;0;False;1;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;121;-4813.919,1.544723;Inherit;False;96;UV;1;0;OBJECT;;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;60;-3360.803,-653.3893;Float;False;Property;_MaskScroll;Mask Scroll;11;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ScaleAndOffsetNode;48;-4496.568,33.13488;Inherit;True;3;0;FLOAT2;0,0;False;1;FLOAT;1;False;2;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;119;-3168.585,-919.4288;Inherit;False;96;UV;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleTimeNode;67;-3112.901,-400.709;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;61;-3102.942,-782.9276;Float;False;Property;_MaskScale;Mask Scale;10;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;123;-4214.224,886.0826;Inherit;False;96;UV;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.BreakToComponentsNode;114;-3971.783,890.0696;Inherit;False;FLOAT2;1;0;FLOAT2;0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
...
Node;AmplifyShaderEditor.SimpleAddOpNode;33;-4079.919,33.84533;Inherit;True;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ScaleAndOffsetNode;62;-2884.997,-914.0279;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT;1;False;2;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SamplerNode;32;-3773.421,6.270464;Inherit;True;Property;_RippleTexture;Ripple Texture;13;1;[NoScaleOffset];Create;True;0;0;False;0;False;-1;None;940942cbd112b074ea5147810de1f6b6;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;42;-3653.505,236.5968;Float;False;Property;_RippleValue;Ripple Value;14;0;Create;True;0;0;False;0;False;0.1;0.03;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;64;-2551.641,-913.4097;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SamplerNode;65;-2335.108,-940.7314;Inherit;True;Property;_MaskTex;Mask Texture;8;1;[NoScaleOffset];Create;False;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;66;-2205.498,-718.4229;Float;False;Property;_MaskValue;Mask Value;9;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;31;-3335.475,11.29842;Inherit;True;3;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;124;-2938.117,5.766363;Inherit;False;UVDistortion;-1;True;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.CommentaryNode;127;-2353.039,517.1312;Inherit;False;285;165;Add Ripple;1;126;;0.1921569,1,0.5140226,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;117;-2331.05,178.2304;Inherit;False;258;165;Add UV;1;99;;1,0.8416586,0.1921569,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;134;-1727.586,642.8346;Inherit;False;308;165;Add Gradient Opacity;1;135;;1,0.3074892,0.1921569,1;0;0
Node;AmplifyShaderEditor.GetLocalVarNode;126;-2303.04,567.1313;Inherit;False;124;UVDistortion;1;0;OBJECT;;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;99;-2283.65,226.9304;Inherit;False;96;UV;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.CommentaryNode;104;-2710.258,347.448;Inherit;False;272;165;Add Opacity Mask;1;102;;0.1933962,0.7241934,1,1;0;0
Node;AmplifyShaderEditor.GetLocalVarNode;135;-1677.586,692.8346;Inherit;False;128;GradientOpacity;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.ToggleSwitchNode;80;-1911.009,230.1624;Inherit;False;Property;_UVDistortion;UV Distortion;12;0;Create;True;0;0;False;1;Header(Ripple Options);False;0;2;0;FLOAT2;11,1;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.GetLocalVarNode;102;-2660.258,397.448;Inherit;False;100;BlendMask;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;136;-1356.971,693.6261;Inherit;False;Property;_ForceParticle1;Force Particle;6;0;Create;True;0;0;False;1;Header(Particle Options);False;0;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.ToggleSwitchNode;73;-2282.292,373.7428;Inherit;False;Property;_BlendMask;Blend Mask;7;0;Create;True;0;0;False;1;Header(Mask Options);False;0;2;0;FLOAT;1;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;58;103.5567,283.8154;Float;False;True;-1;2;;0;7;Loot Beams/Beam Additive;0b6a9f8b4f707c74ca64c0be8e590de0;True;SubShader 0 Pass 0;0;0;SubShader 0 Pass 0;2;True;4;1;False;-1;1;False;-1;0;1;False;-1;1;False;-1;False;False;False;False;False;False;False;False;True;2;False;-1;True;True;True;True;False;0;False;-1;False;False;False;False;True;2;False;-1;True;3;False;-1;False;True;4;Queue=Transparent=Queue=0;IgnoreProjector=True;RenderType=Transparent=RenderType;PreviewType=Plane;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;0;;0;0;Standard;0;0;1;True;False;;False;0
...
ASEEND*/
//CHKSM=C126221DD893F964D8F3D25B6AA1637A55D416FF