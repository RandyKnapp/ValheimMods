...
namespace EpicLoot.Crafting
{
    public static class CraftingItemExtensions
    {
        ...
        {
            return item.m_shared.m_itemType == ItemDrop.ItemData.ItemType.Material && item.m_shared.m_ammoType.EndsWith("MagicCraftingMaterial");
        }
        ...
        {
            return item.m_shared.m_itemType == ItemDrop.ItemData.ItemType.Material && item.m_shared.m_ammoType.EndsWith("Runestone");
        }
