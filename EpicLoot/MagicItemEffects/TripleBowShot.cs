...
namespace EpicLoot.MagicItemEffects
{
    ...
    public static class TripleBowShot
    {
        public static void Prefix(Attack __instance)
        {
            ...
            if (player.HasActiveMagicEffect(MagicEffectType.TripleBowShot) && weaponDamage.HasValue && ItemType == ItemDrop.ItemData.ItemType.Bow && SkillType == Skills.SkillType.Bows)
            {
